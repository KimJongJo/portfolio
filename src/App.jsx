    ...
    const projects = [
            ...
            roles: [
                {
                    title: "사용자 서비스 기능 개발",
                    items: [
                        "수리 노하우 공유를 위한 커뮤니티 게시판 및 게시글 관리 기능 구현",
                        "자재 옵션 선택, 장바구니, 결제 API 연동 등 커머스 핵심 흐름 개발",
                        "대화형 UI를 적용하여 사용자 경험을 개선한 견적 요청 시스템 구축",
                    ],
                },
                {
                    title: "통합 관리자 시스템(Back-office) 구축",
                    items: [
                        "회원 상태 관리 및 전문가·업체 승인/반려 워크플로우 설계",
                        "주문, 결제, 대여 등 전체 서비스 이용 내역에 대한 통합 어드민 구현",
                        "정산 대상 데이터 집계 및 매출 통계 시각화 대시보드 개발",
                    ],
                },
            ],
            ...
            proImg: [
                {
                    ...
                    content: "통합 검색 기능을 중심으로 전문가, 자재, 공구 등 카테고리별 추천 상품을 노출하여 사용자 탐색 편의성 강화",
                },
                {
                    title: "견적 요청",
                    img: "/about-me/projects/zipddakRequest.png",
                    content: "수리, 인테리어, 컨설팅 서비스 유형별 맞춤 질문 세트를 구성하고, 대화형 UI를 통한 상세 견적 요청서 작성 기능 구현",
                },
                {
                    title: "장바구니",
                    img: "/about-me/projects/zipddakCart.png",
                    content: "브랜드별 상품 자동 분류 및 동일 상품 중복 추가 시 수량 합산, 배송비 자동 산출 로직 적용",
                },
                {
                    title: "자재구매",
                    img: "/about-me/projects/zipddakPayment.png",
                    content: "Toss Payments API 연동을 통해 다양한 결제 수단을 지원하고, 결제 승인 및 취소 등 주문 라이프사이클 관리",
                },
                {
                    title: "관리자 페이지 통계",
                    img: "/about-me/projects/zipddakAdmin.png",
                    content: "전월 대비 매출 비교 및 월별 수익 구조, 회원 수 변동 지표를 한눈에 파악할 수 있는 데이터 시각화 대시보드 구축",
                },
            ],
        },
        {
            ...
            roles: [
                {
                    ...
                    items: ["OAuth 기반 소셜 로그인 및 기존 계정 이력 확인을 통한 계정 병합 로직 처리", "병원 상세 정보 수정 및 실시간 반영 기능 구현"],
                },
                {
                    title: "병원/진료 관리 기능 구축",
                    items: ["진료 내용을 바탕으로 한 전자 진단서 작성 및 히스토리 관리 시스템 개발", "내원 환자의 과거 진료 이력 조회 및 작성자 중심의 진단서 열람 권한 제어"],
                },
                {
                    title: "운영 관리자 기능 개발",
                    items: ["사용자 활동 상태 변경 및 전체 회원 정보 관리 기능 구현", "병원 입점 신청 현황 모니터링 및 심사·승인 프로세스 구축"],
                },
            ],
            ...
            proImg: [
                {
                    title: "메인화면",
                    img: "/about-me/projects/ieumMain.png",
                    content: "자가진단, 병원 찾기, 커뮤니티 등 주요 서비스로의 접근성을 높이기 위해 직관적인 사용자 인터페이스 기반 통합 엔트리 구축",
                },
                {
                    title: "진단서 작성",
                    img: "/about-me/projects/ieumWrite.png",
                    content: "환자의 과거 진료 히스토리 데이터를 실시간으로 연동하여 의료진이 연속성 있는 진단 내용을 작성할 수 있도록 기능 구현",
                },
                {
                    title: "과거 진단 기록",
                    img: "/about-me/projects/ieumHistory.png",
                    content: "정보 보안 및 개인정보 보호를 위해 의료진 본인이 직접 작성한 진단 데이터에 대해서만 접근 가능한 필터링 로직 적용",
                },
                {
                    title: "병원 제휴 심사",
                    img: "/about-me/projects/ieumAuth.png",
                    content: "사업자등록증 검토 등 증빙 서류 기반의 검증 단계를 설계하여, 신규 병원 입점 신청에 대한 승인 및 반려 워크플로우 구축",
                },
            ],
        },
        // {
        ...
        // },
        {
            ...
            roles: [
                ...
                {
                    title: "사용자 편의 기능",
                    items: ["북마크 기능을 통한 관심 영화 등록/해제 및 마이페이지 내 저장 목록 관리", "OAuth 소셜 로그인 연동 및 최초 로그인 시 자동 가입·세션 관리 구현"],
                },
            ],
            ...
            proImg: [
                {
                    title: "메인화면",
                    img: "/about-me/projects/jmoveMain.png",
                    content: "프로젝트 핵심 소개와 함께 슬라이드 UI를 적용하여 실시간 인기 영화 목록을 시각적으로 노출하는 큐레이션 기능 구현",
                },
                {
                    title: "로그인",
                    img: "/about-me/projects/jmoveLogin.png",
                    content: "OAuth 소셜 로그인 연동으로 인증 절차를 간소화하고, 최초 로그인 시 사용자 정보 자동 저장 및 세션 관리 로직 적용",
                },
                {
                    title: "영화정보",
                    img: "/about-me/projects/jmoveMovie.png",
                    content: "외부 API 연동을 통해 영화별 줄거리, 평점, 포스터 등 상세 메타데이터를 수집하여 사용자에게 최적화된 상세 정보 노출",
                },
                {
                    title: "영화검색",
                    img: "/about-me/projects/jmoveSearch.png",
                    content: "검색 키워드 기반의 실시간 데이터 필터링을 구현하고, 조건에 따른 영화 리스트 조회 및 검색 결과 처리 시스템 구축",
                },
                {
                    title: "북마크",
                    img: "/about-me/projects/jmoveMypage.png",
                    content: "사용자별 관심 영화 북마크 기능을 구현하여, 개인별 즐겨찾기 목록을 별도 페이지에서 관리할 수 있는 환경 제공",
                },
            ],
        },

        {
            ...
            roles: [
                {
                    title: "실시간 채팅 시스템",
                    items: ["회원-관리자 간 실시간 메시징 기능 및 메시지 수신 알림 구현", "읽지 않은 메시지 카운트 표시 기능을 통한 응답 환경 구축"],
                },
                {
                    title: "사용자 인증 및 계정 관리",
                    items: ["OAuth 기반 소셜 로그인 연동으로 회원가입 및 인증 프로세스 간소화", "아이디/비밀번호 찾기 등 사용자 계정 복구 및 관리 기능 구현"],
                },
                {
                    title: "쇼핑 편의 기능",
                    items: ["다중 상품 일괄 결제를 위한 장바구니 시스템 및 관심상품(즐겨찾기) 기능 개발", "관심 상품 저장을 통함 사용자 재방문 및 구매 접근성 개선"],
                },
            ],
            ...
            proImg: [
                {
                    title: "로그인",
                    img: "/about-me/projects/wheelLogin.png",
                    content: "신규 및 기존 가입자 분기 처리를 통해 로그인·회원가입 로직을 구현하고, 이메일 중복 검사 및 추가 정보 입력 페이지 연동",
                },
                {
                    title: "아이디/비밀번호찾기",
                    img: "/about-me/projects/wheelFind.png",
                    content: "인증 데이터 기반의 회원 조회 기능을 구현하고, 일반 가입 아이디 노출 또는 소셜 로그인 방식 안내 등 맞춤 정보 제공",
                },
                {
                    title: "관심상품/장바구니",
                    img: "/about-me/projects/wheelCart.png",
                    content: "장바구니 내 선택 상품 삭제 및 실시간 결제 금액 계산 기능을 구현하고, 상품 유형(대여/구매)별 장바구니 담기 로직 적용",
                },
                {
                    title: "1:1 채팅",
                    img: "/about-me/projects/wheelChat.png",
                    content: "사용자용 실시간 채팅 및 알림 기능을 구축하고, 관리자 화면 내 읽지 않은 문의 최상단 정렬 및 실시간 읽음 처리 상태 관리",
                },
            ],
        },
        {
            ...
            roles: [
                ...
                {
                    title: "상품 정보 및 쇼핑 기능",
                    items: ["카테고리별 상품 목록 조회 및 상세 정보 노출 기능 개발", "다중 상품 보관 및 관리를 위한 장바구니 시스템 구축"],
                },
                {
                    title: "운영 관리자 기능",
                    items: ["신규 상품 등록 및 상품 정보(가격, 이미지 등) 관리 기능 구현", "재고 상황에 따른 판매 상태(판매중/품절) 실시간 전환 시스템 구축"],
                },
            ],
            ...
            proImg: [
                {
                    title: "상품 검색",
                    img: "/about-me/projects/seedSearch.png",
                    content: "키워드 기반의 실시간 상품 조회와 검색 결과 부재 시 예외 처리를 구현하고, 높은/낮은 가격순 및 카테고리별 정렬 필터 적용",
                },
                {
                    title: "상품 등록",
                    img: "/about-me/projects/seedAdd.png",
                    content: "관리자 전용 상품 관리 시스템을 구축하여 신규 상품 데이터 등록 및 실시간 메인 목록 반영 기능 구현",
                },
                {
                    title: "상품 품절 및 판매 관리",
                    img: "/about-me/projects/seedEnd.png",
                    content: "상품 상태(판매/품절)에 따른 목록 노출 제어 로직을 설계하여, 품절 처리 시 메인 화면 자동 제외 및 판매 재개 기능 적용",
                },
                {
                    title: "장바구니",
                    img: "/about-me/projects/seedCart.png",
                    content: "목록 및 상세 페이지 내 다중 진입로를 구축하고, 선택 상품별 수량 증감 및 체크 여부에 따른 실시간 결제 금액 산출 기능 구현",
                },
                {
                    title: "문의 게시판",
                    img: "/about-me/projects/seedWrite.png",
                    content: "게시글과 댓글의 생성·수정·삭제(CRUD) 기능을 구축하고, 조회수 집계 및 좋아요 등 사용자 상호작용 기능 구현",
                },
            ],
        },
    ];
                                            ...
                                            {project.proImg?.map((f, i) => (
                                                <li className="feature-item" key={i}>
                                                    ...
                                                    <div className="feature-text">
                                                        ...
                                                        {f.content && <p className="feature-content">{f.content}</p>}
                                                    </div>
                                                </li>
                                            ))}
                                        </ul>
