    ...
    const projects = [
...

        {
            ...
            trouble: {
                ...
                improvement: [
                    "캠핑장 등 야외에서 스마트폰으로 접속하는 사용자가 많은 서비스 특성을 고려하여, 모바일 최적화 반응형 UI를 구축할 계획입니다. 또한, 인터넷 속도가 느린 환경에서도 빠른 로딩을 보장하기 위해 사용자가 업로드한 이미지를 서버단에서 WebP 포맷으로 자동 변환하여 저장하여 사용자의 체감 속도를 개선하고자 합니다.",
                ],
            },
